...
pub const HINT_ROOM_CHOICE_CAN_SKIP: &str = "Room: 'f' face • 's' skip";
pub const HINT_ROOM_CHOICE_NO_SKIP: &str = "Room: 'f' face (skip already used)";
...
pub const HINT_INTERACTION_ACK: &str = "Resolved: press Enter to continue";
